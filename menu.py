                ...
                if int(day) != 0:
                    ...
                    if selected_recipes:
                        ...
                        if old_recipe and new_recipe:
                            ...
                            if replace_result:
                                print(
                                    f"Se ha reemplazado {old_recipe[2]} por {new_recipe[2]} con exito."
                                )
                            else:
                                print(f"Ha ocurrido un error, abortando...")
                    else:
                        print(
                            f"\n{f"X===X NO SE ENCUENTRAN RECETAS EN EL DIA {day_name.upper() if day_name else ""} X===X":^40}"
                        )
        ...
        if selected == 0:
            ...
            if user_recipes:
                ...
                if recipe_opt:
                    ...
                    if branch_opt == 1:
                        print(
                            f"Receta: {selected_recipe[2]}\nInstrucciones: {selected_recipe[3]}"
                        )

                        new_recipe_name = input(
                            "Ingrese el nuevo nombre o Enter para saltear: "
                        )
                        while not v.validate_edit_name(new_recipe_name):
                            new_recipe_name = input(
                                "Ingrese un nombre valido o Enter para saltear: "
                            )

                        new_recipe_instructions = input(
                            "Ingrese las nuevas instrucciones o Enter para saltear: "
                        )
                        while not v.validate_edit_name(new_recipe_instructions):
                            new_recipe_instructions = input(
                                "Ingrese unas instrucciones validas o Enter para saltear: "
                            )
                        ...
                        if edit_ing_opt == 1:
                            ...
                            if mis_ingredientes:
                                ...
                                while ingredient_opt != 0:
                                    ...
                                    unit_name = f.get_unit_by_id(selected_ingredient[3])
                                    cantidad = float(
                                        input(f"Ingrese la cantidad en {unit_name}: ")
                                    )
                                ...
                                print(
                                    f'Ingredientes agregados a "{selected_recipe[2]}".'
                                )
                            else:
                            ...
                            if recipe_ingredients:
                                ...
                                if ingredient_opt != 0:
                                    ...
                                    print(
                                        f'Ingrediente eliminado de "{selected_recipe[2]}".'
                                    )
                            else:
                                print(
                                    "Esta receta no tiene ingredientes para eliminar."
                                )
            else:
                print(f"\n{'X===X NO SE ENCUENTRAN RECETAS X===X':^40}")